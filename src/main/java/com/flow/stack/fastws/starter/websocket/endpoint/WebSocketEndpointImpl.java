...
import static com.flow.stack.fastws.starter.websocket.endpoint.AbstractWebSocketEndpoint.IDENTIFIER;
 ...
 * @date 2020-08-06
 */
@ServerEndpoint(value = "${flow.fastws.webSocket.connect.path}" + "{" + IDENTIFIER + "}")
